INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (1, '2023-11-01 02:07:05.096', 'Hidden Customer Acquisition Costs', 'In the world of business, calculating customer acquisition costs is often seen as a straightforward equation, primarily involving the expenses incurred in marketing and sales efforts. However, there exists a hidden dimension, an underappreciated facet, that could significantly impact these costs – the often-overlooked cost of losing customers.', '# Hidden Customer Acquisition Costs
...
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (2, '2023-11-01 02:07:05.156', 'Are you a leader? Or a boss?', 'This article discusses the fundamental distinction between leadership and bossing in the realm of management styles, emphasizing the importance of understanding which approach one employs. It begins by outlining the characteristics of a leader, who inspires and empowers their team, recognizing the significance of motivation and empowerment. In contrast, a boss is described as someone who issues directives and relies on disciplinary measures for motivation. ', '# Are you a Leader or a Boss?
...
', 'cloeq3vrb0000r03jx0mf7ke5', 1, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (3, '2023-11-01 02:07:05.208', 'Tips for Managing a Remote or Distributed Team', 'This article delves into the intricacies of managing remote or distributed teams, highlighting the growing prevalence of remote work in today\'s fast-paced world. It outlines ten valuable tips for effectively managing such teams. ', '# Tips for Managing a Remote or Distributed Team
...
', 'cloeq3vrb0000r03jx0mf7ke5', 1, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (4, '2023-11-01 02:07:05.266', 'Building a High-Performing Team', 'Congratulations on your new role as a supervisor! This article offers valuable guidance for new supervisors on how to build and lead a high-performing team. It begins by emphasizing the importance of leading by example, inspiring team members through your work ethic and professionalism. Effective communication is identified as a cornerstone for team success, promoting open dialogue and clarity.', '# Building a High-Performing Team: Strategies for New Supervisors
...
', 'cloeq3vrb0000r03jx0mf7ke5', 1, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (5, '2023-11-01 02:07:05.302', 'Essential Programming Concepts', 'This article highlights five essential programming concepts that every developer, whether a beginner or experienced, should have a firm grasp of. ', '# 5 Essential Programming Concepts Every Developer Should Know
...
```
Mastering these concepts will provide a solid foundation for your programming journey, regardless of the language you choose to work with.', 'cloeq3vrb0000r03jx0mf7ke5', 3, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (6, '2023-11-01 02:07:05.382', 'Cross-Platform Programming', 'This article delves into the realm of cross-platform programming, outlining various languages and frameworks that have gained popularity for their ability to write code that runs on multiple operating systems. It starts with a quote emphasizing the importance of coding as a creative language for all.', '# Cross-Platform Programming
...
The choice of language and framework depends on your specific project requirements, familiarity with the technology stack, and the user experience you aim to deliver. Each of these options has its strengths and weaknesses, so consider your development goals and constraints carefully when making a decision.', 'cloeq3vrb0000r03jx0mf7ke5', 5, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (7, '2023-11-01 02:07:05.438', 'The Art of Problem-Solving in Programming', '
This article emphasizes the art of problem-solving in programming and provides valuable tips to enhance problem-solving skills for programmers. It begins with a quote stressing the importance of writing code that humans can understand, not just computers.', '# The Art of Problem-Solving in Programming
...
```
Remember that problem-solving in programming is not just about finding any solution; it\'s about finding the most efficient and elegant one. Developing strong problem-solving skills will make you a more proficient and confident programmer.', 'cloeq3vrb0000r03jx0mf7ke5', 3, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (8, '2023-11-01 02:07:05.509', 'Which Programming Language Should You Learn', 'This article offers a comprehensive guide to help individuals decide which programming language to learn based on their goals, background, and interests. It begins with a quote emphasizing the role of programming in shaping the future.', '# Which Programming Language Should You Learn
...
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (9, '2023-11-01 02:07:05.567', 'Zero Origin Numbers', 'This informative article explains the concept of zero origin numbers, a common source of confusion for new programmers. It begins by defining zero origin numbers, which means that the first item in a list is referred to as item 0, not item 1, as is the case in many programming languages.', '# Zero Origin Numbers
...
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (10, '2023-11-01 02:07:05.617', 'The Importance of Code Comments in Programming', 'This article highlights the importance of code comments in programming, shedding light on their often overlooked but crucial role in software development. It commences with a quote underlining the notion that code should ideally be self-explanatory.', '# The Importance of Code Comments in Programming
...
In summary, code comments are an essential part of professional programming. They enhance code readability, aid in collaboration, and make maintenance and debugging more efficient.', 'cloeq3vrb0000r03jx0mf7ke5', 3, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (11, '2023-11-01 02:07:05.663', 'Application Code Testing', 'This article delves into the importance of code testing in software development and highlights how code testing frameworks can significantly improve the quality and reliability of applications. It begins by explaining the concept of application code testing and the necessity of writing code to test other code.', '# Application Code Testing
...
', 'cloeq3vrb0000r03jx0mf7ke5', 3, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (12, '2023-11-01 02:07:05.701', 'Hello World', 'This is a concise and informative overview of programming languages, emphasizing that most languages share common fundamental features while differing primarily in syntax and available libraries. It highlights the importance of libraries as a key factor in choosing a programming language and briefly mentions popular languages for various platforms, including Swift, Go, Java, Kotlin, and more.', '# Programming Languages
...
12. **TypeScript:**
    ...
    ```
', 'cloeq3vrb0000r03jx0mf7ke5', 3, null, null, 1);
INSERT INTO jerryhobby.Article (id, date, title, summary, text, userId, categoryId, image, tags, commentsEnabled) VALUES (13, '2023-11-01 02:07:05.758', 'The Myth of Artificial Intelligence', '
This article provides a balanced and insightful perspective on the state of artificial intelligence (AI), debunking some common myths while addressing real challenges associated with AI technology. It is crucial to manage expectations around AI and to understand its current capabilities and limitations.', '# The Myth of Artificial Intelligence
